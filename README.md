...
<p>With love,<br>Together as One</p>
    ...
    <script>
        document.getElementById('generateEmailLinks').addEventListener('click', function () {
            ...
            const recipient = 'president@wayne.edu, gx5460@wayne.edu, ac0475@wayne.edu, marilyn.kelly@wayne.edu, bi7880@wayne.edu, co8435@wayne.edu, dp8192@wayne.edu, dana.thomas4@wayne.edu, ab0414@wayne.edu, drpadge@wayne.edu, alex.boesch@wayne.edu, s.khan@wayne.edu, davidstrauss@wayne.edu';
